...
/**
 * 
 * this file is to implement a 'Hierarchical db structure'
...
class CreateOrder_sub extends Component {
  constructor(props) {
    super(props);
    this.state = {
          ...
          <div className="row">
            <div className="input-field col s6">
              <input
                ...
                onChange={this.handleChange.bind(this)}
              />
              <label htmlFor="shipAddr">addr1</label>
            </div>
            <div className="input-field col s6">
              <input
                type="text"
                ...
                onChange={this.handleChange.bind(this)}
              />
              <label htmlFor="shipAddr">addr2</label>
            </div>
            <div className="input-field col s6">
              <input
                type="text"
                ...
                onChange={this.handleChange.bind(this)}
              />
              <label htmlFor="shipAddr">addr3</label>
            </div>
          </div>
          <div className="row">
            <div className="input-field col s6">
